 ...
 */
final class ShurlocFAQSchemaIntegrationTest extends TestCase {
	 ...
	 *
	 * @var Shurloc_FAQ_Schema_Integration
	 */
	private Shurloc_FAQ_Schema_Integration $integration;
	...
	protected function setUp(): void {
		...
		$this->parser =
			new Shurloc_FAQ_Schema_Parser();

		$this->generator =
			new Shurloc_FAQ_Schema_Generator();

		$this->integration =
			new Shurloc_FAQ_Schema_Integration(
				parser: $this->parser,
